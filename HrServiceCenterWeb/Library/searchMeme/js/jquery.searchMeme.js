(function ($) {
    $.fn.extend({
        searchMeme: function (options) {
            ...
            var settings = $.extend({ animationSpeed: 500, defaultText: '', button: 'white', buttonPlacement: 'left', onSearch: null, searchComplete: false }, options);
            ...
            return this.each(function () {
                ...
                searchBox.keydown(function (e) {
                	...
                	//取消鼠标点击文本框，内容清空的处理
                	//searchBox.removeClass('searchMeme-water-mark').val(''); return false;
                	searchBox.removeClass('searchMeme-water-mark'); return false;
                	}).blur(function () {
                    if ($(this).val() == '')
